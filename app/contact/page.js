      ...
      <section className="relative w-full h-screen bg-gray-800 flex items-center justify-center text-center">
        ...
        <div className="relative z-20 px-4">
          <img
            src="/maindp.jpg"
            alt="My Image"
            className={`w-40 h-40 rounded-full mx-auto transition-transform duration-1000 ease-in-out transform ${loading ? 'scale-0' : 'scale-100'}`}
            onLoad={() => setLoading(false)}
          />
          <h1 className="text-5xl text-white font-bold mt-6">Hello, Im [Your Name]</h1>
